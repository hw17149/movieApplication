...
public class User {
	...
	public User(String userName, String fname, String lname, String email, String password, String location, int userType, boolean confirmation, boolean subscribed, String bDate, boolean resetPassword, boolean banStatus) {
		super();
